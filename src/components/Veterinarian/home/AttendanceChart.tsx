    ...
    <div className="mt-6 bg-white rounded-2xl borde border-gray-200">
      {!hideHeader && (
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-base font-bold text-gray-800">{t('dashboard.attendances')}</h2>
            <p className="text-xs text-gray-500">{t('dashboard.totalAttendances')}</p>
          </div>
          <button
            type="button"
      ...
      {showCounters && (
        <div className="flex gap-3 mb-4">
          <button className="px-3 py-1 borde border-gray-300 rounded-full text-sm flex items-center gap-2 bg-gray-100">
            ...
            <span className="font-medium text-sm">{dogsTotal} <span className='text-[#839297]'>{t('dashboard.dogs')}</span></span>
          </button>
          <button className="px-3 py-1 borde border-gray-300 rounded-full text-sm flex items-center gap-2 bg-gray-100">
            ...
            </svg>            <span className="font-medium text-sm">{catsTotal} <span className='text-[#839297]'>{t('dashboard.cats')}</span></span>
          </button>
        </div>
      )}
      {/* legend */}
