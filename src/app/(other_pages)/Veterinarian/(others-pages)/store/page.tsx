...
import { Bell, Check, ChevronLeft, Clock, Download, Eye, Upload } from "lucide-react";
    ...
    <div className="min-h-[100dvh] w-full bg-white">
      <div className="mx-auto w-full pb-6 pt-[calc(env(safe-area-inset-top)+20px)]">
        ...
        <div className=" flex items-center justify-between">
          ...
          <h1 className="text-base font-medium text-gray-900">Store</h1>
        ...
        <div className="mt-6 space-y-4 p-4 rounded-[16px] bg-[#F5F6F6]">
          <StoreModal
            isOpen={true}
