    ...
    <div className="rounded-[12px] bg-white px-4 py-3 shadow-theme-xs">
      ...
      <div className="mt-2.5 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <ActionButton variant="primary" label={t("history.download")} onClick={onDownload}>
          ...
          <ActionButton variant="success" label={t("common.share")} onClick={onShare}>
...
function PageContent() {
  ...
  return (
    <div className=" w-full bg-white">
      <div className="mx-auto w-full h-full pb-6">
        <div className="flex items-start justify-between gap- flex-col px-">
        ...
        <div className="mt-6 space-y-4 p-4 pb-20! h-ful rounded-[16px] bg-[#F5F6F6]">
          {loading ? (
            <div className="text-[14px] text-gray-500">{t("history.loading")}</div>
          ) : sortedItems.length === 0 ? (
            <div className="text-[14px] text-gray-500">{t("history.noReportsYet")}</div>
          ) : (
