      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            ...
            {/* Signed Badge */}
            {signed && (
              <div className="flex items-center gap-1 text-xs text-primary bg-[#EBF2FF] px-2 py-1 rounded-full">
          ...
          <div className="flex items-center justify-end gap-2 mt-3">
            <Button
              ...
              size="sm"
              onClick={onDownload}
              className="rounded-full text-xs bg-primary h-8 px-4 gap-1.5 "
            >
            ...
            <Button
              ...
              size="sm"
              onClick={onDetails}
              className="text-primary bg-[#EBF2FF] rounded-full text-xs h-8 px-4"
            >
              {t("history.details")}
            </Button>
          </div>
